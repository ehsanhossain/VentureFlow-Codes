...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('buyers_financial_details', function (Blueprint $table) {
            ...
            $table->boolean('is_minority')->default(false);          // Is Minority
            $table->boolean('is_majority')->default(false);          // Is Majority
            $table->boolean('is_negotiable')->default(false);        // Is Negotiable
