...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('sellers_company_overviews', function (Blueprint $table) {
            ...
            $table->string('hq_country', 255)->constrained('countries')->nullable();            // HQ/Origin Country
            $table->string('company_type', 100)->nullable();          // Company Type
            $table->string('year_founded', 255)->nullable();       // Year Founded
            ...
            $table->string('txn_timeline', 255)->nullable();           // Expected Transaction Timeline
