...
const ActiveTeaser = ({
  ...
  useEffect(() => {
    ...
    const subs = industries
      .filter((ind: Industry) => selectedIds.includes(ind.id))
      .flatMap((ind: Industry) => ind.sub_industries || []);
  ...
  const handleApplySearch = (formValues: FormValues) => {
    ...
    const appliedFilters: Record<string, unknown> = {
      country: (formValues.HQCountry as { id?: string })?.id || formValues.HQCountry || '',
