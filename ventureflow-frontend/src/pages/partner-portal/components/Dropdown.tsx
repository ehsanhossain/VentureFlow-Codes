...
export const Dropdown = forwardRef<HTMLDivElement, DropdownProps>(
  ...
  const isSelected = (country: Country) => selectedCountries.some((c) => c.id === country.id);
        ...
        {selectedCountries.length > 0 ? (
          multiSelect ? (
            ...
            <div className="flex items-center gap-2 min-w-0 flex-1 truncate">
              ...
              />
              <span className="text-sm text-[#30313d] truncate">{selectedCountries[0].name}</span>
            </div>
          )
        ) : (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    <img
                      ...
                      className="w-5 h-5 rounded-full shrink-0"
                    />
                    <span className="text-sm text-[#30313d] truncate">{country.name}</span>
                  </div>
                  {multiSelect && (
                    <div
